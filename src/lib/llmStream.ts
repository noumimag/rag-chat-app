import { LLMConfig, Citation, SearchResult } from './schema';
    ...
    const messages = [
      {
        ...
        content:
          systemPrompt ||
          `You are a helpful AI assistant. Answer questions based on the provided context. Always cite your sources using the [Source: Title] format when referencing information.`,
      },
      {
        role: 'user',
...
export const defaultConfigs = {
  openai: {
    ...
    maxTokens: 1000,
    systemPrompt:
      'You are a helpful RAG assistant that answers questions based on provided context. Always cite your sources and provide accurate information.',
  },
  anthropic: {
